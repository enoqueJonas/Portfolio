...
function displayProjectCardsPopup() {
  ...
  projectCardsArray.forEach((project) => {
    if (buttonPressed === project.id) {
      projectsPopupDiv.innerHTML = `<div class="popup-project-header">
      <div class="popup-prject-title">
          <p> Tonic </p>
          <img src="./img/Icon - Cancel.png" alt="cancel" class="close-card-popup">
      </div>
      <div class="popup-project-info-frame">
          <p class="works-item-project-info-canopy works-item-project-info-items">
              <span>CANOPY</span>
          </p>
          <img src="img/Counter.png" alt="..."
              class="works-item-project-info-point-1 works-item-project-info-items">
          <p class="works-item-project-info-type">
              <span> Back End Dev</span>
          </p>
          <img src="img/Counter.png" alt="..."
              class="works-item-project-info-point-2 works-item-project-info-items">
          <p class="works-item-project-info-year">
              <span>2022</span>
          </p>
      </div>
  </div>
  <div class="popup-project-img works-item-image-1"> </div>
  <div class="projects-popup-details">
      <div class="project-popuop-description">
          <p>
              Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essent
          </p>
      </div>
      <div class="project-popup-tecnologies">
          <ul class="works-item-project-tecnologies works-item-project-tecnologies-1">
              <li class="works-item-project-tecnologies-item works-item-project-item-html">
                  <span> html </span>
              </li>
              <li class="works-item-project-tecnologies-item works-item-project-item-css">
                  <span> css </span>
              </li>
              <li class="works-item-project-tecnologies-item works-item-project-item-javascript">
                  <span> javaScript </span>
              </li>
          </ul>
          <ul class="works-item-project-tecnologies works-item-project-tecnologies-2">
              <li class="works-item-project-tecnologies-item works-item-project-item-html">
                  <span> github </span>
              </li>
              <li class="works-item-project-tecnologies-item works-item-project-item-css">
          ...
          <div class="project-popup-action">
              <button class="btn-see-source works-item-project-action-button">
                  <span> See Source</span>
                  <img src="./img/icon-GitHub.png" alt="github">
              </button>
              <button class="btn-see-live works-item-project-action-button">
                  <span> See Live</span>
                  <img src="./img/Icon - Export.svg" alt="export">
              </button>
          </div>
      </div>
  </div>`
  projectsPopupDiv.classList.toggle('active-popup');
      ...
      body.appendChild(projectsPopupDiv);
    }
  });
}
